...
workflow testdata_example {
  ...
  call validate_outputs { input:
    ...
    pairtree_ssm = create_pairtree_data.ssm_file,
    pairtree_params = create_pairtree_data.params_file,
  ...
  output {
    ...
    File pairtree_ssm = create_pairtree_data.ssm_file
    File pairtree_params = create_pairtree_data.params_file
...
task validate_outputs {
  ...
  parameter_meta {
    ...
    pairtree_ssm: "Pairtree synthetic SSM file to validate"
    pairtree_params: "Pairtree synthetic params.json file to validate"
  ...
  command <<<
    ...
    validate_file "~{pairtree_ssm}" "Pairtree synthetic SSM file" || validation_passed=false
    validate_file "~{pairtree_params}" "Pairtree synthetic params.json file" || validation_passed=false
