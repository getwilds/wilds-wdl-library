...
task delly_call {
  meta {
    ...
    in_sample_opt: "target_regions_bed:annotation_track:bed,exclude_regions_bed:annotation_track:bed"
    in_ref_req: "reference_fasta:dna_sequence:fasta,reference_fasta_index:data_index:fai"
    in_ref_opt: "none"
    out_sample: "vcf:sequence_variations:vcf,vcf_index:data_index:csi,summary:report:textual_format"
    out_ref: "none"
  }
