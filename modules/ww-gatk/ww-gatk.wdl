...
task create_sequence_dictionary {
  meta {
    ...
    in_ref_opt: "none"
    out_sample: "none"
    out_ref: "sequence_dict:data_index:dict"
  }
...
task mark_duplicates {
  meta {
    ...
    in_sample_req: "bam:nucleic_acid_sequence_alignment:bam,bam_index:data_index:bai"
    in_sample_opt: "none"
    in_ref_req: "none"
    in_ref_opt: "none"
    out_sample: "markdup_bam:nucleic_acid_sequence_alignment:bam,markdup_bai:data_index:bai,duplicate_metrics:quality_control_report:textual_format"
    out_ref: "none"
  }
...
task base_recalibrator {
  meta {
    ...
    operation: "sequencing_quality_control"
    in_sample_req: "bam:nucleic_acid_sequence_alignment:bam,bam_index:data_index:bai"
    in_sample_opt: "intervals:sequence_coordinates:textual_format"
    in_ref_req: "dbsnp_vcf:sequence_variations:vcf,reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict,known_indels_sites_vcfs:sequence_variations:vcf"
    in_ref_opt: "none"
    out_sample: "recalibrated_bam:nucleic_acid_sequence_alignment:bam,recalibrated_bai:data_index:bai,recalibration_report:quality_control_report:textual_format"
    out_ref: "none"
  }
...
task collect_wgs_metrics {
  meta {
    ...
    in_ref_opt: "none"
    out_sample: "metrics_file:quality_control_report:textual_format"
    out_ref: "none"
  }
...
task markdup_recal_metrics {
  meta {
    ...
    in_ref_req: "dbsnp_vcf:sequence_variations:vcf,reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict,known_indels_sites_vcfs:sequence_variations:vcf"
    in_ref_opt: "none"
    out_sample: "recalibrated_bam:nucleic_acid_sequence_alignment:bam,recalibrated_bai:data_index:bai,recalibration_report:quality_control_report:textual_format,duplicate_metrics:quality_control_report:textual_format,wgs_metrics:quality_control_report:textual_format"
    out_ref: "none"
  }
...
task split_intervals {
  meta {
    ...
    in_sample_req: "none"
    in_sample_opt: "intervals:sequence_coordinates:textual_format"
    in_ref_req: "reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "interval_files:sequence_coordinates:textual_format"
    out_ref: "none"
  }
...
task print_reads {
  meta {
    ...
    in_ref_req: "reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "interval_bams:nucleic_acid_sequence_alignment:bam,interval_bam_indices:data_index:bai"
    out_ref: "none"
  }
...
task haplotype_caller {
  meta {
    ...
    in_sample_req: "bam:nucleic_acid_sequence_alignment:bam,bam_index:data_index:bai"
    in_sample_opt: "intervals:sequence_coordinates:textual_format"
    in_ref_req: "dbsnp_vcf:sequence_variations:vcf,reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
...
task mutect2 {
  meta {
    ...
    in_sample_req: "bam:nucleic_acid_sequence_alignment:bam,bam_index:data_index:bai"
    in_sample_opt: "intervals:sequence_coordinates:textual_format"
    in_ref_req: "gnomad_vcf:sequence_variations:vcf,reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "vcf:sequence_variations:vcf,vcf_index:data_index:tbi,unfiltered_vcf:sequence_variations:vcf,unfiltered_vcf_index:data_index:tbi,stats_file:report:vcf,f1r2_counts:report:tar_format"
    out_ref: "none"
  }
...
task merge_vcfs {
  meta {
    ...
    in_sample_req: "vcfs:sequence_variations:vcf,vcf_indices:data_index:tbi"
    in_sample_opt: "none"
    in_ref_req: "reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "merged_vcf:sequence_variations:vcf,merged_vcf_index:data_index:tbi"
    out_ref: "none"
  }
...
task merge_mutect_stats {
  meta {
    ...
    species: "eukaryote"
    operation: "aggregation"
    in_sample_req: "stats:report:vcf"
    in_sample_opt: "none"
    in_ref_req: "none"
    in_ref_opt: "none"
    out_sample: "merged_stats:report:textual_format"
    out_ref: "none"
  }
...
task haplotype_caller_parallel {
  meta {
    ...
    species: "eukaryote"
    operation: "variant_calling"
    in_sample_req: "bam:nucleic_acid_sequence_alignment:bam,bam_index:data_index:bai,intervals:sequence_coordinates:textual_format"
    in_sample_opt: "none"
    in_ref_req: "dbsnp_vcf:sequence_variations:vcf,reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "vcf:sequence_variations:vcf,vcf_index:data_index:tbi"
...
task mutect2_parallel {
  meta {
    ...
    in_ref_req: "gnomad_vcf:sequence_variations:vcf,reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "vcf:sequence_variations:vcf,vcf_index:data_index:tbi,unfiltered_vcf:sequence_variations:vcf,unfiltered_vcf_index:data_index:tbi,stats_file:report:vcf"
    out_ref: "none"
  }
...
task fastq_to_bam {
  meta {
    ...
    in_ref_req: "none"
    in_ref_opt: "none"
    out_sample: "unmapped_bam:nucleic_acid_sequence_alignment:bam"
    out_ref: "none"
  }
...
task validate_sam_file {
  meta {
    ...
    species: "any"
    operation: "sequencing_quality_control"
    in_sample_req: "input_file:nucleic_acid_sequence_alignment:bam|sam|cram"
    in_sample_opt: "none"
    in_ref_req: "none"
    in_ref_opt: "reference_fasta:nucleic_acid_sequence:fasta"
    out_sample: "validation_report:quality_control_report:textual_format"
    out_ref: "none"
  }
...
task analyze_saturation_mutagenesis {
  meta {
    ...
    in_ref_req: "reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "none"
    out_sample: "aa_counts:report:textual_format,aa_fractions:report:textual_format,codon_counts:report:textual_format,codon_fractions:report:textual_format,cov_length_counts:report:textual_format,read_counts:report:textual_format,ref_coverage:report:textual_format,variant_counts:report:textual_format"
    out_ref: "none"
  }
...
task create_somatic_pon {
  meta {
    ...
    species: "eukaryote"
    operation: "aggregation"
    in_sample_req: "normal_vcfs:sequence_variations:vcf,normal_vcf_indices:data_index:tbi,intervals:sequence_coordinates:textual_format"
    in_sample_opt: "none"
    in_ref_req: "reference_fasta:nucleic_acid_sequence:fasta,reference_fasta_index:data_index:fai,reference_dict:data_index:dict"
    in_ref_opt: "germline_resource:sequence_variations:vcf"
    out_sample: "none"
    out_ref: "pon_vcf:sequence_variations:vcf,pon_vcf_index:data_index:tbi"
  }
