...
workflow sra_cellranger {
  ...
  parameter_meta {
    ...
    skip_on_chemistry_failure: "If true, samples Cell Ranger can't assign a chemistry to are skipped (recorded in skipped_sample_list, absent from cellranger_* arrays) instead of failing the workflow. Default: false."
