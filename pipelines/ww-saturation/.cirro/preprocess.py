...
def setup_inputs(ds: PreprocessDataset):
    ...
    inputs = {
        "saturation_mutagenesis.samples": format_inputs_samples(ds),
        "saturation_mutagenesis.reference_fasta": ds.params["reference_fasta"],
        "saturation_mutagenesis.reference_fasta_index": ds.params["reference_fasta_index"],
        "saturation_mutagenesis.reference_dict": ds.params["reference_dict"],
        "saturation_mutagenesis.orf_range": ds.params["orf_range"],
        "saturation_mutagenesis.cpu_cores": ds.params["cpu_cores"],
        "saturation_mutagenesis.memory_gb": ds.params["memory_gb"]
    }
...
def format_inputs_samples(ds: PreprocessDataset):
    """
    Format the inputs using the SaturationSample struct syntax:
