...
workflow splicing_proteomics {
  ...
  parameter_meta {
    ...
    output_prefix: "Prefix for output file names (default: 'splicing_proteomics')"
    sjdb_overhang: "STAR splice junction overhang parameter (default: 100)"
    genome_sa_index_nbases: "STAR genome index parameter (typically 10-15, scales with genome size, default: 14)"
    rmats_anchor_length: "Minimum nucleotides at junction ends for rMATS (default: 1)"
    rmats_novel_splice_sites: "Enable detection of unannotated splice sites in rMATS (default: false)"
    rmats_cstat: "Cutoff splicing difference for rMATS statistical testing (default: 0.0001)"
    jcast_min_read_count: "Minimum junction read count for JCAST translation (default: 1)"
    jcast_qvalue_min: "Minimum FDR q-value threshold for JCAST (default: 0)"
    jcast_qvalue_max: "Maximum FDR q-value threshold for JCAST (default: 1)"
    jcast_splice_types: "Comma-separated splice types for JCAST (MXE,RI,SE,A3SS,A5SS). Empty for all (default: '')"
    star_cpu: "Number of CPU cores for STAR alignment tasks (default: 8)"
    star_memory_gb: "Memory allocation in GB for STAR alignment tasks (default: 64)"
